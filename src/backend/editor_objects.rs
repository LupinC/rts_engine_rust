    ...
    match tab {
        PaletteTab::Resource => vec![
            ...
            PaletteEntry {
                name: "Gem",
                emoji: "💎",
                color: egui::Color32::from_rgb(245, 220, 80),
            },
            PaletteEntry {
                name: "Oil",
                emoji: "🛢️",
                color: egui::Color32::from_rgb(70, 200, 110),
            },
        ],
        PaletteTab::SpawnPoints => vec![
            PaletteEntry {
                name: "Player 1",
                emoji: "①",
                color: egui::Color32::from_rgb(90, 180, 255),
            },
            PaletteEntry {
                name: "Player 2",
                emoji: "②",
            ...
            PaletteEntry {
                name: "Waypoint",
                emoji: "⭐",
                color: egui::Color32::from_rgb(170, 170, 255),
            },
        ],
    }
}
